...
export default function WhyChooseUs() {
  ...
  return (
    <section ref={ref} className="py-20 relative bg-gradient-to-b from-brand-dark via-gray-900/50 to-brand-dark">
      <div className="section-padding">
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <p className="text-brand-light-blue/60 tracking-widest mb-4">WHY CHOOSE US</p>
        ...
        <div className="mt-16 text-center">
          <div className="inline-block glass-effect rounded-full px-8 py-4">
            <p className="text-brand-light-blue font-semibold text-lg">
              🔥 今なら導入サポート無料！先着10社限定
            </p>
          </div>
        </div>

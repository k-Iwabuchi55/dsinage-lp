      ...
      <div className="section-padding">
            ...
            >
              {plan.recommended && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="bg-gradient-gold text-brand-black px-6 py-2 rounded-full text-sm font-bold tracking-wider">
                    〜おすすめ〜
                    {/* 人気No.1 */}
                  </span>
                </div>
              ...
              <div className="mb-6">
                <p className="text-brand-gold/60 text-sm tracking-widest mb-2">{plan.subtitle}</p>
              ...
              <div className="mb-6">
                <p className="text-brand-gold font-semibold mb-4">こんな方におすすめ</p>
              ...
              <div className="mb-8 p-4 bg-brand-gold/5 rounded-lg">
                <p className="text-brand-gold font-semibold mb-3 text-sm">導入効果</p>
        ...
        <div className="mt-16 text-center max-w-3xl mx-auto">
          <div className="glass-effect rounded-xl p-6">
            <p className="text-brand-gold font-semibold mb-3">こんな店舗におすすめ</p>
            <p className="text-white/70 text-sm leading-relaxed">
              キャバクラ・ガールズバー・ホストクラブ・ラウンジ・スナックなど、
        ...
        {/* <div className="mt-8 text-center">
          <p className="text-white/60 text-sm">
            ※価格は全て税抜き表示です。店舗規模により料金が変動する場合があります。
          </p>
        </div> */}
      </div>
    </section>

      ...
      <div className="section-padding">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <button 
              onClick={scrollToTop}
              className="text-brand-gold font-bold text-xl tracking-wider hover:text-brand-gold/80 transition-colors cursor-pointer" 
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#contact" className="bg-gradient-gold text-brand-black px-6 py-2 rounded-full hover-glow font-semibold tracking-wider">
              お問い合わせ
            </a>
          </div>
          ...
          >
            <div className="absolute inset-0 bg-brand-gold/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
        ...
        >
          <div className="bg-black/90 backdrop-blur-md rounded-lg p-4">
            ...
            <a 
              href="#contact" 
              onClick={handleMobileMenuClick}
              className="block text-brand-gold hover:text-brand-gold/80 py-2 transition-colors"
            >
              お問い合わせ
            </a>
          </div>
